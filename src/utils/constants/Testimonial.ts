...
// ];
{
  id: 1,
  name: 'Navya Mukku',
  role: 'SAS Programming Trainee',
  image: '/images/testimonials/navya.jpg',
  quote: 'The SAS Programming course was clear, structured, and hands-on. It made complex concepts easy and boosted my confidence in data analysis.',
  rating: 5,
},
{
  id: 2,
  name: 'Pilli Ashwini',
  role: 'Clinical SAS Trainee',
  image: '/images/testimonials/ashwini.jpg',
  quote: 'The Clinical SAS training covered both Base and Advanced SAS with practical applications. Very well-structured and easy to follow.',
  rating: 5,
},
{
  id: 3,
  name: 'Shalvee Surve',
  role: 'Clinical SAS Intern',
  image: '/images/testimonials/shalvee.jpg',
  quote: 'The Clinical SAS internship was well-organized and focused on real clinical trial scenarios. It gave me strong practical skills.',
  rating: 5,
},
{
  id: 4,
  name: 'Krutika Hadole',
  role: 'SAS Trainee',
  image: '/images/testimonials/krutika.jpg',
  quote: 'The SAS classes were highly informative and practical. More assignments would help, but overall a great experience.',
  rating: 5,
},
{
  id: 5,
  name: 'Sindhuja Reddy',
  role: 'SAS Programming Trainee',
  image: '/images/testimonials/sindhuja.jpg',
  quote: 'The SAS training covered everything from basics to advanced reporting. Very clear explanations and industry-oriented content.',
  rating: 5,
},
{
  id: 6,
  ...
  image: '/images/testimonials/apeksha.jpg',
  quote: 'The pharmacovigilance training was worth it. The mentor explained everything clearly and the sessions were very interactive.',
  rating: 5,
},
{
  id: 7,
  name: 'Pranali Ravekar',
  role: 'Medical Coding Trainee',
  image: '/images/testimonials/pranali.jpg',
  quote: 'Dr. Pravallika’s teaching in Medical Coding was excellent. I understood every topic clearly. The team is very supportive.',
  rating: 5,
},
{
  id: 8,
  name: 'Mansi Alane',
  role: 'Pharmacovigilance Intern',
  image: '/images/testimonials/mansi.jpg',
  quote: 'I gained so much confidence through this pharmacovigilance internship. The mentors were supportive and communicative.',
  rating: 5,
},
{
  id: 9,
  name: 'Akshee',
  role: 'SAS Programming Intern',
  image: '/images/testimonials/akshee.jpg',
  quote: 'The SAS Programming course was amazing with clear explanations and practical sessions that improved my analysis skills.',
  rating: 5,
},
{
  id: 10,
  name: 'Amena Tabassum',
  role: 'Medical Coding Trainee',
  image: '/images/testimonials/amena.jpg',
  quote: 'Learning medical coding here was a great decision. The mentors were highly cooperative and explained everything perfectly.',
  rating: 5,
},
{
  id: 11,
  name: 'Bhavitha',
  role: 'Pharmacovigilance Intern',
  image: '/images/testimonials/bhavitha.jpg',
  quote: 'The pharmacovigilance internship was a great experience with easy-to-understand materials and excellent mentors.',
  rating: 5,
},
{
  id: 12,
  name: 'Shweta Sarwadikar',
  role: 'Clinical SAS Intern',
  image: '/images/testimonials/shweta.jpg',
  quote: 'Excellent Clinical SAS training with clear explanations and very useful hands-on exercises. Highly recommended.',
  rating: 5,
},
{
  id: 13,
  name: 'Komal Galande',
  role: 'SAS Programming Trainee',
  image: '/images/testimonials/komal.jpg',
  quote: 'The SAS programming course was well-structured, simple to understand, and covered all important topics.',
  rating: 5,
},
{
  id: 14,
  name: 'Sejal Chavan',
  role: 'Clinical SAS Trainee',
  image: '/images/testimonials/sejal.jpg',
  quote: 'A fantastic program covering SAS concepts with real clinical applications. Very helpful for career growth.',
  rating: 5,
},
{
  id: 15,
  name: 'Hetu Patel',
  role: 'Clinical SAS Intern',
  image: '/images/testimonials/hetu.jpg',
  quote: 'VisionTech provided real-time Clinical SAS training that helped my career growth immensely.',
  rating: 5,
},
{
  id: 16,
  ...
  image: '/images/testimonials/ravalika.jpg',
  quote: 'VisionTech taught me so much during my pharmacy-related training. It helped me develop strong skills.',
  rating: 5,
},
{
  id: 17,
  name: 'Naveen Kumar',
  role: 'Pharmacovigilance Trainee',
  image: '/images/testimonials/naveen.jpg',
  quote: 'The pharmacovigilance course was very helpful with hands-on projects that built my confidence.',
  rating: 5,
},
{
  id: 18,
  ...
  quote: 'The pharmacovigilance internship was a good experience. Teaching and materials were excellent.',
  rating: 5,
},
{
  id: 19,
  name: 'Gowthami Satharajupalli',
  role: 'Medical Coding Intern',
  image: '/images/testimonials/gowthami.jpg',
  quote: 'The medical coding internship helped me understand all concepts clearly. Great platform for learning.',
  rating: 5,
},
{
  id: 20,
  name: 'Konisi Bhavana',
  role: 'Clinical SAS Intern',
  image: '/images/testimonials/bhavana.jpg',
  quote: 'I learned so much about Clinical SAS and feel confident in my new skills. Amazing internship experience!',
  rating: 5,
},
]