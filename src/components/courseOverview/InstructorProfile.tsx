...
const InstructorProfile = () => {
  ...
  return (
    <div className="max-w-5xl rounded-3xl border border-border overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row gap-6 p-6">
          ...
          <div className="flex-grow">
            ...
            <p className="text-gray-600 text-sm mb-6 leading-relaxed">
              ...
              understand. I apply everything I discover into my bootcamp course.
              In my courses you&apos;ll find lots of geeky humor but also lots
              of explanations and animations to make sure everything is easy to
